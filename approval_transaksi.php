...
if($idtransaksi!=''){
$querye=mysql_query("update transaksi_keluar set status_user=1 where id_transaksi_keluar='$idtransaksi'");
if ($querye) {
...
<table border="0" class="table table-striped">
	...
	<?php $query=mysql_query("select * from transaksi_keluar where status_transaksi=0 and status_user=0");
